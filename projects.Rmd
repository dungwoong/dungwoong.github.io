...
FastGAN is a (relatively)lightweight image-generation model that boasts good image synthesis results with little input data.

I trained it on the researcher's Anime faces dataset, and then used discord.py to create a Discord Bot that can present the results of each GAN.

I am attempting to further existing research in the field. The project is still in progress.
