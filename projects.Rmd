...
Created a classification model to predict match outcomes of the popular game, League of Legends, with ~80% accuracy.
...
Currently fine-tuning the model and continuing to process the data
