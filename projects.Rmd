...
*Curated collection of generated Faces. All credit for the training data goes to [SamDoesArts](https://www.instagram.com/samdoesarts/)*

The goal of this project is to create high quality, structurally sound generations of digital portraits, using few-shot learning(training from scratch with <200 images). 

Humans are especially good at facial recognition, making this a difficult generation task. I have three datasets of portraits drawn by different digital artists, each with increasing complexity, and am testing the effectiveness of different architectures and techniques.

FastGAN is a (relatively)lightweight image-generation model that boasts good image synthesis results with little input data. I am using it as a base model for my investigation.
